...
Modelica.Fluid.Interfaces.FluidPort_b particle_port_out(redeclare package Medium = Medium) annotation(
  Placement(visible = true, transformation(origin = {-70, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-70, -28}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
...
Modelica.Blocks.Interfaces.RealInput W_electric annotation(
    Placement(visible = true, transformation(origin = {-69, 31}, extent = {{-9, -9}, {9, 9}}, rotation = 180), iconTransformation(origin = {-79, 29}, extent = {{9, -9}, {-9, 9}}, rotation = -180)));
...
annotation(
    Diagram(graphics = {Rectangle(origin = {0, 9}, extent = {{-70, 33}, {70, -33}}), Text(origin = {1, 8}, extent = {{-37, 12}, {37, -12}}, textString = "Electrical Heater", fontSize = 26), Line(origin = {0, 20}, points = {{-70, 0}, {70, 0}}), Line(origin = {0, -4}, points = {{-70, 0}, {70, 0}})}, coordinateSystem(initialScale = 0.1, extent = {{-100, -100}, {100, 100}})),
    Icon(graphics = {Rectangle(origin = {0, 2}, lineThickness = 1, extent = {{-70, 38}, {70, -38}}), Line(origin = {0, 20}, points = {{-70, 0}, {70, 0}}, pattern = LinePattern.Dash, thickness = 1), Line(origin = {0, -20}, points = {{-70, 0}, {70, 0}}, pattern = LinePattern.Dash, thickness = 1), Text(origin = {1, 1}, textColor = {0, 0, 255}, extent = {{-57, 15}, {57, -15}}, textString = "Heater")}, coordinateSystem(initialScale = 0.1, extent = {{-100, -100}, {100, 100}})));
